from app.database.repositories import CredentialRepository, UserRepository
...
def test_save_credentials(credential_repository : CredentialRepository, user_repository : UserRepository):
